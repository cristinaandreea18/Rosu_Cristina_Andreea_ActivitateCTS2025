...
public class Main {
    public static void main(String[] args){
        BicicletaBuilder builder = new BicicletaBuilder("Mountain Bike");
        Bicicleta b1 = builder.setDiametruRoti(40).setHasCascaProtectie(true).setNrViteze(4).setTipFrana("disc").build();
